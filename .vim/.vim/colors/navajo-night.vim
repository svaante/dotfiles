...
hi Search term=bold ctermbg=0 ctermfg=white cterm=bold guibg=Black guifg=Yellow
hi IncSearch term=reverse cterm=bold gui=reverse
hi MoreMsg term=bold ctermfg=green gui=bold guifg=#d174a8
hi ModeMsg term=bold cterm=bold gui=bold
hi LineNr term=underline ctermfg=White ctermbg=NONE guibg=#7f7f7f gui=bold guifg=White
hi Question term=standout ctermfg=darkgreen gui=bold guifg=#d174a8
hi StatusLine cterm=bold ctermbg=black gui=bold guifg=green guibg=Black
hi StatusLineNC cterm=bold ctermfg=grey guifg=#116f6f guibg=#8f8f8f
hi VertSplit cterm=bold ctermfg=black gui=bold guifg=Black guibg=#8f8f8f
...
hi WildMenu term=standout ctermfg=black ctermbg=white guifg=White guibg=Blue
...
hi Statement term=bold ctermfg=Yellow cterm=bold gui=bold guifg=#5ad5d5
hi PreProc term=underline ctermfg=darkmagenta guifg=#74ff74
hi Type term=underline ctermfg=darkblue gui=bold guifg=#d174a8
...
"+++ Cream: selection
highlight Visual   ctermfg=white ctermbg=black gui=bold    guifg=Black guibg=#aacc77
"+++
